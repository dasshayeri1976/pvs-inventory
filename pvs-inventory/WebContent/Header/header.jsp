					...
					<li><a>Inventory Transaction</a>
						<ul>
							<li><a>Purchase Entry</a>
								<ul>
									<li><a href="purchaselist1">Purchase Credit Bill</a></li>
									<li><a href="purchaseretlist">Purchase Cash Bill</a></li>
								</ul>
							</li>	
							<li><a>Sales Memo Entry</a>
								<ul>
									<li><a href="csalesmemeoentry">Sales Memo(Counter)</a>	</li>
									<li><a href="salesmemeoentry">Sales Memo(Outside)</a></li>
									<li><a href="msalesmemeoentry">Sales Memo(MRP)</a></li>
									<li><a href="dsalesmemeoentry">Sales Memo(Distributor)</a></li>		
								</ul>
							 </li>
							<li><a href="salesreturn">Amend Sales Memo</a></li>
							<li><a href="salesreturn">Loading Chart</a></li>
							<li><a href="salesreturn">Sales Summary</a></li>
							<li><a href="salesreturn">Sales Memo Update</a></li>
							<li><a href="salesreturn">Collection Entry</a></li>
							<li><a href="salesreturn">Sales Return</a></li>
							<li><a href="salesreturn">Debit Note</a></li>
							<li><a href="salesreturn">Credit Note</a></li>
