...
<s:actionmessage/>
  ...
  <legend style="color:red;"><h3>Material Group</h3></legend>
  ...
  <table cellpadding="5" width="70%" style="padding:20px">  
  		...
  		<tr>	
      		<td width="12.5%" style="padding-left:15px; padding-right:15px;"><label>Group&nbsp;Description</label></td>
        	...
        	<td width="12.5%" style="padding-left:15px; padding-right:15px;"><sj:autocompleter name="formbean.company" id="company" list="usList"  listValue="company" size="50" cssStyle="height:25px;border:1px solid #ccc;background:#FFFF99" forceValidOption="false"></sj:autocompleter></td>
        </tr>
