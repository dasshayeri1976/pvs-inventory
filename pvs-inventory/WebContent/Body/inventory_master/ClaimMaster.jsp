...
<li>Claim Master</li>
 ...
 <s:form action="claimmaster1" namespace="/" method="post" >

<fieldset style="width:60%; border:solid thin #c6d5e1;Padding:5px;">
  <legend style="color:red;"><h3>Claim Master</h3></legend>
  ...
  <table cellpadding="5" width="70%" style="padding:20px">  
  		...
  		<tr>	
      		<td width="12.5%" style="padding-left:15px; padding-right:15px;"><label>Claim&nbsp;Code</label></td>
        	<td width="12.5%" style="padding-left:15px; padding-right:15px;"><s:textfield name="formbean.claimcode"  id="claimcode" size="30" cssStyle="height:25px;border:1px solid #ccc;background:#FFFF99"></s:textfield></td>
      
        	<td width="12.5%" style="padding-left:15px; padding-right:15px;"><label>Claim&nbsp;Desc</label></td>
        	<td width="12.5%" style="padding-left:15px; padding-right:15px;"><s:textfield name="formbean.claimdesc"  id="claimdesc" size="30" cssStyle="height:25px;border:1px solid #ccc;background:#FFFF99"></s:textfield></td>
        </tr>
...
<s:if test="usList">
	...
	<display:column property="claimcode"   title="Claim Code" style="background-color:#ecf2f6;"   sortable="false" headerClass="sortable" />
	
	<display:column property="claimdesc"   title="Claim Desc"  style="background-color:#ecf2f6;"   sortable="false" headerClass="sortable"/>
	
	<display:column title="Update" media="html" style="text-align: center;width:8%;background-color:#ecf2f6;" >
    <a href="<s:url action="claimupdate" namespace="/" ><s:param  name="id" value="%{#attr.table1.id}"></s:param></s:url>" style="color:  #fff;text-decoration:none;font-size:12px;" class="classname">Update</a>
    </display:column>
    
    <display:column title="Delete" media="html" style="text-align: center;width:8%;background-color:#ecf2f6;" >
    <a href="<s:url action="claimdelete" namespace="/" ><s:param  name="id" value="%{#attr.table1.id}"></s:param></s:url>" style="color:  #fff;text-decoration:none;font-size:12px;" class="print" onclick="return confirmation();">Delete</a>
    </display:column>
	</s:if>
	...
	<s:else>
	<display:column property="claimcode"   title="Claim Code" style="background-color:#fff;"   sortable="false" headerClass="sortable" />
	
	<display:column property="claimdesc"   title="Claim Desc"  style="background-color:#fff;"   sortable="false" headerClass="sortable"/>
