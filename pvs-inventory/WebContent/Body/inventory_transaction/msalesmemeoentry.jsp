...
//alert(lc);
 ...
 function showdiv1()
 {
   ...
   //  var repl=document.getElementsByClassName("replacement");
     ...
     var url = "./Body/inventory_transaction/meteriallistvalue5.jsp";
...
<s:actionmessage/>
  ...
  <s:form action="msalesmemeocreation" namespace="/" method="post" autocomplete="off">
