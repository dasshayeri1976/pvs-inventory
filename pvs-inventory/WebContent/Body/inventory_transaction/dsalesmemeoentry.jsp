...
//alert(lc);
 ...
 function showdiv1()
 {
   ...
   //  var repl=document.getElementsByClassName("replacement");
     ...
     var url = "./Body/inventory_transaction/meteriallistvalue4.jsp";
...
<s:actionmessage/>
  ...
  <legend style="color:red;">ENTRY OF CASH/CREDIT MEMO FOR DISTRIBUTOR SALES</legend>
  
  <s:form action="dsalesmemeocreation" namespace="/" method="post" autocomplete="off">
  <input type="hidden" name="formbean.id" value="<s:property value="formbean.id"/>"/>
  
  <table cellpadding="5" width="50%" style="padding:5px">  
 
  		<%-- <s:textfield name="formbean.type1" id="type1" cssClass="type1"  size="30" cssStyle="height:25px;border:1px solid #ccc;background:#FFFF99"></s:textfield>
         --%>
...
<td width="12.5%" style="padding-left:150px;" ><label>Add</label></td>
   ...
   <div align="right" style="width:99%;position:relative;  padding:7px;">
    ...
    <a href="<s:url action="dsalesmemeoupdate" namespace="/" ><s:param  name="id" value="%{#attr.table111.id}"></s:param></s:url>" style="color:  #fff;text-decoration:none;font-size:12px;" class="classname">Update</a>
    </display:column>
    
    <display:column title="Delete" media="html" style="text-align: center;width:8%;background-color:#ecf2f6;" >
    <a href="<s:url action="dsalesmemeodelete" namespace="/" ><s:param  name="id" value="%{#attr.table111.id}"></s:param></s:url>" style="color:  #fff;text-decoration:none;font-size:12px;" class="print" onclick="return confirmation();">Delete</a>
    </display:column>
	</s:if>
	<s:else>
