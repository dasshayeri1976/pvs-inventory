...
<div style="position:fixed;top:150px;bottom: 45px;overflow-y:auto;width:100%" align="center">   
    <fieldset style="width:50%; border:solid thin #c6d5e1;Padding:5px;" align="center">
    	<legend style="color:red;"><h3>Subgroup Trial Balance</h3></legend>
    	<s:form action="subgrouptrialsearch" namespace="/" method="post" autocomplete="off">
    		Search As On: <%-- <s:textfield name="formbean.uptodate" id="uptodate" cssStyle="border:1px solid #ccc;height:25px;background:#FFFF99;width:120px;"/> --%>
    		
    		<%-- added by Nilesh, 19th April --%>
    		<sj:datepicker name="formbean.uptodate" id="uptodate" size="9" buttonImageOnly="true" displayFormat="yy-mm-dd" showButton="false" changeYear="true" changeMonth="true" cssStyle="border:1px solid #ccc;height:25px;background:#FFFF99;width:120px;" />
    ...
    <font color="red"><b><u>--:: Detail Subgroup Trial Balance Display ::--</u></b></font><br>
	...
	<display:column title="SubGroup Name" property="ledger"  style="background-color:#fff;"  sortable="false" headerClass="sortable">
    
    </display:column>
    
    <display:column property="subgroups"   title="Group Name"  style="background-color:#fff;"  sortable="false" headerClass="sortable" />
