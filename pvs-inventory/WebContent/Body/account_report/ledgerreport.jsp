...
<s:actionmessage/>
    ...
    <font color="red"><b><u>--:: Detail Trial Balance Display ::--</u></b></font><br/>
	<font color="red"><s:textfield id="led" name="formbean.led" style="color:red;border:none;text-align:center;width:300px" readonly="true"/></font><br/>

	<p>&nbsp;</p>
	<s:if test="usList">
	
	<display:table id="table"  name="usList" pagesize="25"  class="imagetable hvr-table-effect" requestURI="" export="true" style="width:70%;color:#000">
	
	<display:column  title="Months"  style="background-color:#fff;"  sortable="false" headerClass="sortable" >
     <a href="<s:url action="monthwisereport" namespace="/" ><s:param  name="months" value="%{#attr.table.months}"></s:param><s:param  name="ledger" value="%{#attr.table.ledger}"></s:param></s:url>" style="color:  red;text-decoration:none;"><s:property value="%{#attr.table.months}"/></a>
   	</display:column>
   
    <display:column property="nv"   title="NV"  style="background-color:#fff;"  sortable="false" headerClass="sortable" />
	 
    <display:column property="opebal"   title="Opening Balance"  style="background-color:#fff;"  sortable="false" headerClass="sortable" />
	
	<display:column property="debitam"   title="Debit Amount" style="background-color:#fff;"   sortable="false" headerClass="sortable" />
	
	<display:column property="creditam"   title="Credit Amount" style="background-color:#fff;"   sortable="false" headerClass="sortable" />
	
	<display:column property="closing"   title="Closing Balance" style="background-color:#fff;"   sortable="false" headerClass="sortable" />
