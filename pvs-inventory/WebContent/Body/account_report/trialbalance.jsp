...
<div style="position:fixed;top:150px;bottom: 45px;overflow-y:auto;width:100%" align="center">    
    <fieldset style="width:50%; border:solid thin #c6d5e1;Padding:5px;" align="center">
    	<legend style="color:red;"><h3>Ledger Trial Balance</h3></legend>
    	<s:form action="trialsearch" namespace="/" method="post" autocomplete="off">
	...
	<display:column title="Ledger Name"  style="background-color:#fff;"  sortable="false" headerClass="sortable">
    <a href="<s:url action="ledgerreport" namespace="/" ><s:param  name="ledger" value="%{#attr.table.ledger}"></s:param></s:url>" style="color:red;text-decoration:none;"><s:property value="%{#attr.table.ledger}"/></a>
    </display:column>
    
    <display:column property="group"   title="Group Name"  style="background-color:#fff;"  sortable="false" headerClass="sortable" />
