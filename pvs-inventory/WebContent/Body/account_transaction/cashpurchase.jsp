...
function show()
{
	...
	//s1=s1.replace('&','*');
	var url = "./Body/account_transaction/getsrnoforcashpurchase.jsp";
...
function ccode1()//geting current bal of on a/c
{
	...
	if (typeof XMLHttpRequest != "undefined") 
	{
		xmlHttp00101 = new XMLHttpRequest();
	}
	else if (window.ActiveXObject) 
	{
		xmlHttp00101 = new ActiveXObject("Microsoft.XMLHTTP");
	}
	if (xmlHttp00101 == null) 
	{
		alert("Browser does not support XMLHTTP Request");
		return;
	}
	...
	xmlHttp00101.onreadystatechange = codeAdd05;
	xmlHttp00101.open("GET", url, true);
	xmlHttp00101.send(null);
}
function codeAdd05() 
{
	if (xmlHttp00101.readyState == 4 || xmlHttp00101.readyState == "complete") 
	{			
		var x1=xmlHttp00101.responseText;
		var x2=parseInt(x1);
		if(x2 < 0)
		{
...
<body onload="ccode1();ccode();getnarration();show();partlist();"><center>
</s:if>
<s:else>
<body onload="ccode1();ccode();test12a()"><center>
</s:else>
...
<div style="position:fixed;top:160px;bottom: 45px;overflow-y:auto;width:100%" align="center">   
    <s:form action="cashpurchasecreation1" namespace="/" method="post" autocomplete="off">
  ...
  <legend style="color:red;"><h3>Cash Purchase</h3></legend>
  <div align="left">
 ...
 <br>
  ...
  <div align="right">
  <label>Total:- </label><input type="text" id="total" name="formbean.total" readonly style="border:none;color:red"></input>
  </div>
...
<a href="ledgerlist" accesskey="c"></a><!-- create ledger hot key-->
    ...
    <a href="<s:url action="cashpurchaseupdate" namespace="/" ><s:param  name="id" value="%{#attr.table12.id}"></s:param></s:url>" style="color:  #fff;text-decoration:none;font-size:12px;" class="classname">Update</a>
    </display:column>
    
    <display:column title="Delete" media="html" style="text-align: center;width:8%;background-color:#ecf2f6;" >
    <a href="<s:url action="cashpurchasedelete" namespace="/" ><s:param  name="id" value="%{#attr.table12.id}"></s:param></s:url>" style="color:  #fff;text-decoration:none;font-size:12px;" class="print" onclick="return confirmation();">Delete</a>
    </display:column>
    
     <display:column title="Print" media="html" style="text-align: center;width:8%;background-color:#ecf2f6;" >
    <a href="./Body/transaction_print/cashpurchaseprint.jsp?id=<s:property value="%{#attr.table12.id}" />" style="color:  #fff;text-decoration:none;font-size:12px;" class="classname" onclick="">Print</a>
    </display:column>
	</s:if>
	<s:else>
