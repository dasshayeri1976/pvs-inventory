if (!AmCharts)
    var AmCharts = {themes: {}, maps: {}, inheriting: {}, charts: [], onReadyArray: [], useUTC: !1, updateRate: 40, uid: 0, lang: {}, translations: {}, mapTranslations: {}};
    ...
    if (l) {
        ...
        if (n.width > h) {
            ...
            if (isNaN(s)) {
                ...
                for (p = 1; p < h; p++)
                    s = Math.round(b.length / h * p), b = b.substr(0, s) + m + b.substr(s);
...
AmCharts.ValueAxis = AmCharts.Class({inherits: AmCharts.AxisBase, construct: function(a) {
        ...
        if (this.logarithmic && (0 >= this.getMin(0, this.data.length -
            ...
            if (isNaN(this.min) || isNaN(this.max) || !this.foundGraphs || Infinity == this.min || -Infinity == this.max)
                ...
                u = !1;
                for (d = p; d < q; d += n)
                    y = AmCharts.roundTo(this.step * d + this.min, s), -1 != String(y).indexOf("e") && (u = !0, String(y).split("e"));
                    ...
                    if (p =
                        ...
                        if (isNaN(v) || Number(AmCharts.toFixed(p, v)) == p) {
                            ...
                            if (!isNaN(I) && 0 < y && d < q - 1) {
                                ...
                                for (c = 1; c < s / I; c++)
                                    E = this.getCoordinate(p + I * c), E = new this.axisItemRenderer(this, E, "", !1, 0, 0, !1, !1, 0, !0), this.pushAxisItem(E);
                                this.gridAlpha = t
                            }
                        }
                d = this.baseValue;
        ...
        for (c = 0; c < b.length; c++) {
            ...
            if (d.valueAxis == this) {
                ...
                if (l = a.recalculateFromDate)
                    a.dataDateFormat && (l = AmCharts.stringToDate(l, a.dataDateFormat)), g = a.getClosestIndex(a.chartData, "time", l.getTime(), !0, 0, a.chartData.length), h = a.chartData.length - 1;
...
AmCharts.AmChart = AmCharts.Class({construct: function(a) {
        ...
        if (a) {
            ...
            if (a != this.previousWidth || f != this.previousHeight)
                b.style.width = a + "px", b.style.height = f + "px", e && e.setSize(a, f);
    ...
    addMouseWheel: function() {
        ...
        this.chartRendered ||
                (a = "rendered", this.fire(a, {type: a, chart: this}), this.chartRendered = !0);
        a = "drawn";
...
AmCharts.AmGraph = AmCharts.Class({construct: function(a) {
        ...
        var a =
                this.valueAxis.stackType, b = [], c = [], d, e, f;
        ...
        isNaN(h) && (h = .8);
        var l = this.useNegativeColorIfDown, m = this.width, n = this.height, p = this.y, q = this.rotate, r = this.columnCount, s = AmCharts.toCoordinate(this.cornerRadiusTop, h / 2), v = this.connect, w = [], t = [], u, y, E, A, z = this.chart.graphs.length, K, I = this.dx / this.depthCount,
                F = this.dy / this.depthCount, H = f.stackType, L = this.labelPosition, ha = this.start, ba = this.end, $ = this.scrollbar, Ra = this.categoryAxis, na = this.baseCoord, ta = this.negativeBase, V = this.columnIndex, X = this.lineThickness, Z = this.lineAlpha, oa = this.lineColorR, R = this.dashLength, Y = this.set, qa = L, G = this.getGradRotation(), B = this.chart.columnSpacing, W = Ra.cellWidth, ca = (W * h - r) / r;
        B > ca && (B = ca);
        var ja, x, ab, jb = n + 1, kb = m + 1, bb = 0, lb = 0, mb, nb, cb, db, ob = this.fillColorsR, Da = this.negativeFillColors, wa = this.negativeLineColor, Sa = this.fillAlphas,
        ...
        for (J = ha; J <= ba; J++) {
            ...
            if (va) {
                ...
                if ("candlestick" == g || "ohlc" == g)
                    U = va.close, rb = va.low, xa = f.getCoordinate(rb), qb = va.high, ya = f.getCoordinate(qb);
                ka = va.open;
                C = f.getCoordinate(U);
                ...
                var la = ja.x[Ra.id], Oa = this.periodSpan - 1, ma = Math.floor(W / 2) + Math.floor(Oa *
                        W / 2), za = ma, Hb = 0;
                ...
                U < ka && (x.isNegative =
                        !0, Da && (Ca = Da), Ta && (Wa = Ta), void 0 != wa && (ua = wa));
                Ua = !1;
                isNaN(U) || (l ? U > Na ? (Ma && (Ua = !0), Ma = !1) : (Ma || (Ua = !0), Ma = !0) : x.isNegative = U < ta ? !0 : !1);
                switch (g) {
                    case "line":
                        if (isNaN(U))
                            v || (this.drawLineGraph(w, t, O, P), w = [], t = [], O = [], P = []);
                        else {
                            ...
                            if (Ua || void 0 != x.lineColor || void 0 != x.fillColors || !isNaN(x.dashLength))
                                this.drawLineGraph(w, t, O, P), w = [D], t = [C], O = [], P = [], !Ea || isNaN(M) ||
                    ...
                    case "smoothedLine":
                        if (isNaN(U))
                            v || (this.drawSmoothedGraph(w, t, O, P), w = [], t = [], O = [], P = []);
                        else {
                            if (Math.abs(D - fb) >= hb || Math.abs(C - gb) >= hb)
                                w.push(D), t.push(C), fb = D, gb = C;
                            aa = D;
                    ...
                    case "step":
                        if (!isNaN(U)) {
                            if (void 0 == x.lineColor && void 0 == x.fillColors && isNaN(x.dashLength) || (this.drawLineGraph(w,
                                    ...
                                    za), P.push(M))), u = D, y = C, E = N, A = M, aa = D, ia = C, ea = D, fa = C, Ua && (this.drawLineGraph(w, t, O, P), w = [], t = [], O = [], P = [], l && (Ma ? (this.lineColorSwitched = oa, this.fillColorsSwitched = ob) : (this.lineColorSwitched = wa, this.fillColorsSwitched = Da))), Gb || x.gap)
                                u = y = NaN, this.drawLineGraph(w, t, O, P), w = [], t = [], O = [], P = []
                        } else if (!v) {
                            if (1 >= this.periodSpan || 1 < this.periodSpan && D - u > ma + za)
                                u = y = NaN;
                        ...
                        if (!isNaN(U)) {
                            ...
                            if (!(U < Ib && ka < Ib || U > Jb && ka > Jb))
                                if (q) {
                                    ...
                                    if (S < m + V * I && 0 < Q)
                                        if (ra = new AmCharts.Cuboid(e, Q, da, I - a.d3x, F - a.d3y, Ca, Wa, X, pa, this.lineAlpha, G, s, q, R, Xa), 0 > U && "middle" != L && "inside" != L)
                                            L = "bottom";
                                        else if (L =
                                                qa, "regular" == H || "100%" == H)
                                            ia += this.dy
                    ...
                    case "ohlc":
                        if (!(isNaN(ka) || isNaN(qb) || isNaN(rb) || isNaN(U))) {
                            ...
                            var yb, zb, Ab;
                            if (q) {
                                var Bb = C - h / 2, Bb = AmCharts.fitToBounds(Bb, 0, n), Kb =
                                        AmCharts.fitToBounds(C, 0, n), Cb = C + h / 2, Cb = AmCharts.fitToBounds(Cb, 0, n);
                                ...
                                var Db = D - h / 2, Db = AmCharts.fitToBounds(Db, 0, m), Lb = AmCharts.fitToBounds(D, 0, m), Eb = D + h / 2, Eb = AmCharts.fitToBounds(Eb, 0, m);
                ...
                if (!$ && !isNaN(U)) {
                    ...
                    if (this.end - this.start <= Mb || 0 === Mb) {
                        ...
                        if (Nb) {
                            var ga = this.createLabel(x, 0, 0, Nb), Ia = 0, Ja = 0, Ob = ga.getBBox(), Pa = Ob.width, Ka = Ob.height;
                            switch (L) {
                                case "left":
                                    Ia = -(Pa / 2 + Ha / 2 + 3);
                                    break;
                                ...
                                case "bottom":
                                    q &&
                                            "column" == g ? (aa = na, 0 > U || 0 < U && f.reversed ? (Ia = -6, ga.attr({"text-anchor": "end"})) : (Ia = 6, ga.attr({"text-anchor": "start"}))) : (Ja = Ha / 2 + Ka / 2, ga.x = -(Pa / 2 + 2));
                                    break;
                                case "middle":
                        ...
                        if ("regular" == H || "100%" == H) {
                            ...
                            if (Qb) {
                                ...
                                var Rb = Qa.getBBox(), Sb = Rb.width, Tb = Rb.height, Ya, Za, Ub = f.totals[J];
                                Ub && Ub.remove();
                                var $a = 0;
                                "column" != g && ($a = Ha);
        ...
        if ("line" == g || "step" == g || "smoothedLine" == g)
            "smoothedLine" == g ? this.drawSmoothedGraph(w, t, O, P) : this.drawLineGraph(w, t, O, P), $ || this.launchAnimation();
    ...
    negativeClip: function(a) {
        ...
        if (1 < a.length) {
            ...
            var s = e.negativeLineColor, w = e.negativeFillColors, t =
                    e.negativeFillAlphas, u = e.baseCoord;
            ...
            if (0 < f || 0 < t)
                if (n = a.join(";").split(";"), q = b.join(";").split(";"), m = g.type, "serial" == m ? 0 <
                        ...
                        q.push(q[0]), n.push(u), q.push(q[0]), n.push(n[0]))), a = e.gradientRotation, 0 < f && (g = AmCharts.polygon(h, n, q, r, f, 1, "#000", 0, a), g.pattern(e.pattern), k.push(g)), w || void 0 !== s)
                    isNaN(t) && (t = f), w || (w = s), h = AmCharts.polygon(h, n, q, w, t, 1, "#000", 0, a), h.pattern(e.pattern), l.push(h), l.click(function(a) {
                        e.handleGraphEvent(a, "clickGraph")
                    }).mouseover(function(a) {
                        e.handleGraphEvent(a, "rollOverGraph")
                    }).mouseout(function(a) {
        ...
        if (1 < a.length) {
            ...
            e.push(h);
            e.push(g);
            var k = this.lineAlpha, l = this.lineThickness, e = this.dashLength, m = this.fillAlphas, n = this.lineColorR, p = this.fillColorsR, q = this.negativeLineColor, r = this.negativeFillColors, s = this.negativeFillAlphas, v = this.baseCoord, w = this.lineColorSwitched;
            w && (n = w);
...
AmCharts.ChartCursor = AmCharts.Class({construct: function(a) {
        ...
        if ("cursor" == this.type) {
            if (this.tempPosition = NaN, AmCharts.ifArray(this.data))
                isNaN(a) && (a = this.getMousePosition()), (a != this.previousMousePosition || !0 === this.zoomed ||
                    ...
                    if (this.forceShow = !1, K) {
                        ...
                        if (this.oneBalloonOnly) {
                            ...
                            for (g = 0; g < I.length; g++)
                                u = I[g], u.showBalloon && !u.hidden && u.balloonText && (y = q.axes[u.valueAxis.id].graphs[u.id], t = y.y, isNaN(t) || (s ? Math.abs(e - t) < k && (k = Math.abs(e - t), H = u) : Math.abs(f - t) < k && (k = Math.abs(f - t), H = u)));
                            ...
                            if (this.normalizeBulletSize(), this.destroyValueBalloons(), this.resizedBullets = [], I && this.valueBalloonsEnabled && w && c.balloon.enabled) {
                                ...
                                for (g = 0; g < I.length; g++)
                                    if (u = I[g], t = NaN, (!this.oneBalloonOnly || u == H) && u.showBalloon && !u.hidden && u.balloonText && ("step" == u.type && "left" == u.stepDirection && (q = this.data[a + 1]), q)) {
                                        if (y = q.axes[u.valueAxis.id].graphs[u.id])
                                            t = y.y;
                                        if (this.showNextAvailable && isNaN(t) && a + 1 < this.data.length)
                                            for (k = a + 1; k < this.data.length; k++)
                                                if (r =
                                                        this.data[k])
                                                    if (y = r.axes[u.valueAxis.id].graphs[u.id], t = y.y, !isNaN(t))
                                                        break;
                                        if (!isNaN(t)) {
                                            r = y.x;
                                            v = !0;
        ...
        if (a) {
            ...
            if (this.enabled && 0 < b.length) {
                if (this.pan)
                    ...
                    c.chart = a;
                    if ("cursor" == this.type)
                        this.rotate ? this.selectionPosY = e : this.selectionPosX = e = d, 2 > Math.abs(e - this.initialMouse) && this.fromIndex == this.index || (this.index < this.fromIndex ? (c.end =
        ...
        if (this.zoomable || this.pan || this.drawing) {
            ...
            if (0 < d && d < this.width && 0 < e && e < this.height || "fake" == a)
                this.setPosition(), this.selectWithoutZooming && AmCharts.remove(this.selection), this.drawing ? (this.drawStartY = e, this.drawStartX = d, this.drawingNow = !0) : this.pan ? (this.zoomable = !1, c.setMouseCursor("move"), this.panning = !0, this.panClickPos = b ? e : d, this.panClickStart = this.start, this.panClickEnd = this.end, this.panClickStartTime = this.startTime, this.panClickEndTime = this.endTime) : this.zoomable && ("cursor" == this.type ?
...
AmCharts.SimpleChartScrollbar = AmCharts.Class({construct: function(a) {
        ...
        m.mouseIsOver && (this.dragging && (m = this.initialCoord, l ? (a = m + (r - a), 0 > a && (a = 0), m = p - h, a > m && (a = m), g.setAttr("y", a)) : (a = m + (q - a), 0 > a && (a = 0), m = n - k, a > m && (a = m), g.setAttr("x", a))), this.resizingRight &&
                ...
                !0, this.resizingLeft = !1, g.setAttr("x", c + k - e)) : (0 === a && (a = .1), g.setAttr("x", d - e), g.setAttr("width", a)))), this.clipDragger(!0))
...
AmCharts.ChartScrollbar = AmCharts.Class({inherits: AmCharts.SimpleChartScrollbar, construct: function(a) {
        ...
        if (this.skipEvent)
            ...
            if (g.parseDates && !g.equalSpacing) {
                if (a = d.lastTime, d = d.firstTime, g.minDuration(), g = Math.round(b / h) + d, b = this.dragging ? g + this.timeDifference : Math.round((b + c) / h) + d, g > b && (g = b), 0 < e && b - g < e && (b = Math.round(g + (b - g) / 2), c = Math.round(e / 2), g = b - c, b += c), b > a && (b = a), b - e < g && (g = b - e), g < d && (g = d), g + e > b && (b = g + e), g != this.startTime || b != this.endTime)
                    this.startTime = g, this.endTime = b, f.start = g, f.end = b, f.startDate = new Date(g), f.endDate = new Date(b),
                            this.fire(f.type, f)
            } else if (g.startOnAxis || (b += h / 2), c -= this.stepWidth / 2, e = g.xToIndex(b), b = g.xToIndex(b + c), e != this.start || this.end != b)
                g.startOnAxis && (this.resizingRight && e == b && b++, this.resizingLeft && e == b && (0 < e ? e-- : b = 1)), this.start = e, this.end = this.dragging ? this.start + this.difference : b, f.start = this.start, f.end = this.end, g.parseDates && (a[this.start] && (f.startDate = new Date(a[this.start].time)), a[this.end] && (f.endDate = new Date(a[this.end].time))), this.fire(f.type, f)
        }
        this.zoomScrollbar()
...
AmCharts.handDrawnLine = function(a, b, c, d, e, f, g, h, k, l, m) {
    ...
    for (m = 1; m < b.length; m++)
        for (var p = [b[m - 1], b[m]], q = [c[m - 1], c[m]], q = AmCharts.makeHD(p, q, a.handDrawScatter), p = q[0], q = q[1], r = 1; r < p.length; r++)
            n.push(AmCharts.line(a, [p[r - 1], p[r]], [q[r - 1], q[r]], d, e, f + Math.random() * a.handDrawThickness - a.handDrawThickness / 2, g, h, k, l, !0));
    return n
};
...
AmCharts.AmLegend = AmCharts.Class({construct: function(a) {
        ...
        this.titleWidth = 0;
        if (e = this.title)
            a = AmCharts.text(this.container, e, this.color, a.fontFamily, this.fontSize, "start", !0), a.translate(this.marginLeft, this.marginTop + this.verticalGap + this.ly + 1), a = a.getBBox(), this.titleWidth =
        ...
        if ("top" == a || "bottom" == a || "absolute" == a || "outside" == a)
            "center" == this.align ? b = f + (h - w.width) / 2 : "right" == this.align && (b = f + h - w.width);
        r.translate(b, l + 1);
            ...
            if (this.useGraphSettings)
                if (m = a.type, this.switchType = void 0, "line" == m ||
                    ...
                    if (g = this.createMarker("rectangle",
                            m, a.fillAlphas, a.lineThickness, d, a.lineAlpha, q, g))
