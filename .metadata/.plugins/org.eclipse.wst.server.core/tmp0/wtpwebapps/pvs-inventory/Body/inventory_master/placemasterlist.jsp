...
<s:actionmessage/>
  ...
  <legend style="color:red;"><h3>Place</h3></legend>
  
  <s:form action="placecreation" namespace="/" method="post" autocomplete="off">
  <input type="hidden" name="formbean.id" value="<s:property value="formbean.id"/>"/>
  <input type="hidden" name="formbean.placecode" value="<s:property value="formbean.placecode"/>"/>
  
  
  <table cellpadding="5" width="70%" style="padding:20px">  
 
  		<tr>	
      		<td width="12.5%" style="padding-left:15px; padding-right:15px;"><label>Place&nbsp;Name</label></td>
        ...
        <tr>
         ...
         <td width="12.5%" style="padding-left:15px; padding-right:15px;"><label>Rate&nbsp;</label></td>
      <td width="12.5%" style="padding-left:15px; padding-right:15px;"><s:select name="formbean.rte" id="rte"  list="#{'Local':'Local', 'Van':'Van'}"	cssStyle="width:80px; border:1px solid #ccc" /></td>
        
        
        <td width="12.5%" style="padding-left:15px; padding-right:15px;"><label>Group&nbsp;</label></td>
        	<td width="12.5%" style="padding-left:15px; padding-right:15px;"><s:textfield name="formbean.group"  id="group" size="30" cssStyle="height:25px;border:1px solid #ccc;background:#FFFF99"></s:textfield></td>
	...
	<display:column property="place"   title="Place Name" style="background-color:#ecf2f6;"   sortable="false" headerClass="sortable" />
    ...
    <a href="<s:url action="placeupdate" namespace="/" ><s:param  name="id" value="%{#attr.table12.id}"></s:param></s:url>" style="color:  #fff;text-decoration:none;font-size:12px;" class="classname">Update</a>
    </display:column>
    
    <display:column title="Delete" media="html" style="text-align: center;width:8%;background-color:#ecf2f6;" >
    <a href="<s:url action="placedelete" namespace="/" ><s:param  name="id" value="%{#attr.table12.id}"></s:param></s:url>" style="color:  #fff;text-decoration:none;font-size:12px;" class="print" onclick="return confirmation();">Delete</a>
    </display:column>
	</s:if>
	...
	<display:column property="place"   title="Place Name" style="background-color:#fff;"   sortable="false" headerClass="sortable" />
	
	<display:column property="sname"   title="Category"  style="background-color:#fff;"   sortable="false" headerClass="sortable"/>
