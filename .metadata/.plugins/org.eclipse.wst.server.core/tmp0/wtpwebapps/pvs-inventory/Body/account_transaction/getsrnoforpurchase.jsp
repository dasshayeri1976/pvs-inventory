...
try
{
	...
	ResultSet rs=smt.executeQuery("select count(voucherno) from accounttransaction where voucherno like 'UD%' ");
	while(rs.next())
	{
		x=rs.getInt(1)+1; 
		//out.print(x);
	}
	sql="select max(entrydate) from accounttransaction where voucherno like 'UD%'";
