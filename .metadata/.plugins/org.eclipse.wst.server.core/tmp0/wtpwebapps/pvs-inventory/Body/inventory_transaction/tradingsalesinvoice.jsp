...
<s:actionmessage/>
  ...
  <s:form action="tradingsalescreation" namespace="/" method="post" autocomplete="off">
  ...
  <fieldset style="width:85%; border:solid thin #c6d5e1;Padding:5px;">
  <legend style="color:red;"><h3>Trading Sales Invoice</h3></legend>
  ...
  <s:else>
  	VAT Cal M.R.P:- <s:radio name="formbean.vatmrp" id="vatmrp" list="#{'1':'Yes','2':'No'}" cssStyle=" border:1px solid #ccc;height:12px;background:#FFFF99;width:15px;" onclick="showpopup(this.value)"></s:radio>
  </s:else>
  </div>
  <div align="right">
  ...
  <table cellpadding="0" width="100%" style="padding:0px" border="0">  
  		<tr>	
        	...
        	<td width="12.5%" style="padding-left:15px; padding-right:15px;"><sj:autocompleter name="formbean.company" id="company" list="usList1"  listValue="company" size="50" cssStyle="height:25px;border:1px solid #ccc;background:#FFFF99;width:290px" forceValidOption="false"></sj:autocompleter></td>	
      		<td width="12.5%" style="padding-left:15px; padding-right:15px;"><label>Party&nbsp;Name:</label></td>
        	<td width="12.5%" style="padding-left:15px; padding-right:15px;"><sj:autocompleter name="formbean.debitac" id="debitac" list="usList2"  listValue="debitac" size="50" cssStyle="height:25px;border:1px solid #ccc;background:#FFFF99;width:290px" forceValidOption="false"></sj:autocompleter></td>
        </tr>
   </table>

   <br>
   <div style="float:left;height:165px;top:200px;bottom:155px;overflow-y:auto;width:92%;">
...
<table border="0" width="100%">
  ...
  <table width="100%" border="0" style="border:0px dotted">  
        ...
        <tr>	
        	...
        	<td width="12.5%" style="padding-left:15px; padding-right:15px;"><div style="width:125px"><label>E.D&nbsp;@%&nbsp;</label>&nbsp;&nbsp;&nbsp;&nbsp;<s:textfield style="width:50px;border:1px solid #ccc;background:#FFFF99;"></s:textfield></div></td>
        ...
        <tr>
			...
			<td width="12.5%" style="padding-left:15px; padding-right:15px;"><div style="width:125px"><label>C.D&nbsp;@%</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<s:textfield style="width:50px;border:1px solid #ccc;background:#FFFF99;"></s:textfield></div></td>
        ...
        <tr>
        	<td width="12.5%" style="padding-left:15px; padding-right:15px;"colspan="4" rowspan="3"><div style="width:100px"><s:textarea name="formbean.narration" id="narration" cols="50" rows="4" maxlength="200" cssStyle="background:#FFFF99;resize:none;width:480px"></s:textarea></div></td>
        	<td width="12.5%" style="padding-left:15px; padding-right:15px;"></td>   
        	<td width="12.5%" style="padding-left:15px; padding-right:15px;"></td>
        	
        	<td width="12%" style="padding-left:15px; padding-right:15px;"><div style="width:140px"><label>CST.PP&nbsp;@%</label><s:textfield style="width:50px;border:1px solid #ccc;background:#FFFF99;"></s:textfield></div></td>
        ...
        <tr>
        	...
        	<td width="12.5%" style="padding-left:15px; padding-right:15px;"><div style="width:140px"><label>I.C&nbsp;@%</label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<s:textfield style="width:50px;border:1px solid #ccc;background:#FFFF99;"></s:textfield></div></td>
		 ...
		 <tr>
        	...
        	<td width="" style="padding-left:15px; padding-right:15px;"><div style="width:140px"><label>V.A.T&nbsp;@%</label>&nbsp;&nbsp;&nbsp;<s:textfield style="width:50px;border:1px solid #ccc;background:#FFFF99;"></s:textfield></div></td>
         ...
         <tr>
            <td width="12.5%" style="padding-left:15px; padding-right:15px;">Credit&nbsp;A/c:</td>
        	<td width="12.5%" style="padding-left:15px; padding-right:15px;"><sj:autocompleter name="formbean.creditac" id="creditac" list="usList6"  listValue="creditac" size="50" cssStyle="height:25px;border:1px solid #ccc;background:#FFFF99;width:250px" forceValidOption="false"></sj:autocompleter></td>
        	...
        	<td width="" style="padding-left:15px; padding-right:15px;"><div style="width:140px"><label>T.O.T&nbsp;@%</label>&nbsp;&nbsp;&nbsp;<s:textfield style="width:50px;border:1px solid #ccc;background:#FFFF99;"></s:textfield></div></td>
       ...
       <tr>
        	...
        	<td width="12.5%" style="padding-left:15px; padding-right:15px;"><label>R.&nbsp;Off</label>&nbsp;&nbsp;&nbsp;<s:radio name="formbean.roundoff" id="roundoff" list="#{'1':'Yes','2':'No'}" value='2' cssStyle=" border:1px solid #ccc;height:12px;background:#FFFF99;width:15px;" onclick="showpopup(this.value)"></s:radio></td>
        	<td width="12.5%" style="padding-left:15px; padding-right:15px;"><s:textfield name="formbean.roundofft"  id="roundofft" onblur="" size="25" cssStyle="height:25px;border:1px solid #ccc;background:#FFFF99;width:100px"></s:textfield></td>
        </tr>
         <tr>
         	<td width="12.5%" style="padding-left:15px; padding-right:15px;"></td>
        	<td width="12.5%" style="padding-left:15px; padding-right:15px;"></td>
        	...
        	<td width="" style="padding-left:15px; padding-right:15px;"><div style="width:140px"><label>Add&nbsp;(If&nbsp;Any)</label><s:textfield style="width:50px;border:1px solid #ccc;background:#FFFF99;"></s:textfield></div></td>
        	<td width="12.5%" style="padding-left:15px; padding-right:15px;"><s:textfield name="formbean.vat"  id="vat" onblur="showDiv();" size="25" cssStyle="height:25px;border:1px solid #ccc;background:#FFFF99;width:100px"></s:textfield></td>    
        </tr>
