...
<title>Counter Sales Memo Entry</title>
...
//alert(lc);
 ...
 function showdiv1()
 {
   ...
   //  var repl=document.getElementsByClassName("replacement");
     ...
     var url = "./Body/inventory_transaction/meteriallistvalue2.jsp";
	...
	function codeAdd2() {
		if (xmlHttp0.readyState == 4 || xmlHttp0.readyState == "complete") 
		{
			  ...
			  if(tax1=="18")
					   ...
					   if(x1.trim()=="IntraState")
						   {
						    ...
						    tax11=Number(tax1) / 2;
						   buffer=buffer+"<tr> <td><input type='text' name='formbean.onamount1' class='onamount' value="+stotalam1+" style='height:25px;border:1px solid #ccc;background:#FFFF99;width:110px;'/></td>"
				    		  +"<td><input type='text' name='formbean.sgst1' class='sgst' value="+tax11+" style='height:25px;border:1px solid #ccc;background:#FFFF99;width:110px;'/></td>"
					    	  +" <td><input type='text' name='formbean.asgst1' class='asgst' value="+stogstam11+" style='height:25px;border:1px solid #ccc;background:#FFFF99;width:110px;'/></td>"
					    	  +"<td><input type='text' name='formbean.cgst1' class='cgst' value="+tax11+" style='height:25px;border:1px solid #ccc;background:#FFFF99;width:110px;' /></td>"
					    	  +" <td><input type='text' name='formbean.acgst1' class='acgst' value="+stogstam11+" style='height:25px;border:1px solid #ccc;background:#FFFF99;width:110px;' /></td>"
					    	  +"<td><input type='text' name='formbean.igst1' class='igst' value="+"NA"+" style='height:25px;border:1px solid #ccc;background:#FFFF99;width:110px;'/></td>"
					    	  +"<td><input type='text' name='formbean.aigst1' class='aigst' value="+"NA"+" style='height:25px;border:1px solid #ccc;background:#FFFF99;width:110px;'/></td>" 
					    	  +"<td><input type='text' name='formbean.gamount1' class='gamount' value="+stogstam1+" style='height:25px;border:1px solid #ccc;background:#FFFF99;width:110px;' /></td></tr>";
				 		  
						   }
					   	else if(x1.trim()=="InterState")
						   {
								buffer=buffer+"<tr> <td><input type='text' name='formbean.onamount1' class='onamount' value="+stotalam1+" style='height:25px;border:1px solid #ccc;background:#FFFF99;width:110px;'/></td>"
		    					  +"<td><input type='text' name='formbean.sgst1' class='sgst' value="+"NA"+" style='height:25px;border:1px solid #ccc;background:#FFFF99;width:110px;'/></td>"
			    				  +" <td><input type='text' name='formbean.asgst1' class='asgst' value="+"NA"+" style='height:25px;border:1px solid #ccc;background:#FFFF99;width:110px;'/></td>"
			    				  +"<td><input type='text' name='formbean.cgst1' class='cgst' value="+"NA"+" style='height:25px;border:1px solid #ccc;background:#FFFF99;width:110px;' /></td>"
			    				  +" <td><input type='text' name='formbean.acgst1' class='acgst' value="+"NA"+" style='height:25px;border:1px solid #ccc;background:#FFFF99;width:110px;' /></td>"
			    				  +"<td><input type='text' name='formbean.igst1' class='igst' value="+tax1+" style='height:25px;border:1px solid #ccc;background:#FFFF99;width:110px;'/></td>"
			    				  +"<td><input type='text' name='formbean.aigst1' class='aigst' value="+stogstam1+" style='height:25px;border:1px solid #ccc;background:#FFFF99;width:110px;'/></td>" 
			    				  +"<td><input type='text' name='formbean.gamount1' class='gamount' value="+stogstam1+" style='height:25px;border:1px solid #ccc;background:#FFFF99;width:110px;' /></td></tr>";
				  ...
				  if(x1.trim()=="IntraState")
				   {
				    ...
				    tax22=Number(tax2) / 2;
				 	  buffer=buffer+"<tr> <td><input type='text' name='formbean.onamount1' class='onamount' value="+stotalam2+" style='height:25px;border:1px solid #ccc;background:#FFFF99;width:110px;'/></td>"
		    		  +"<td><input type='text' name='formbean.sgst1' class='sgst' value="+tax22+" style='height:25px;border:1px solid #ccc;background:#FFFF99;width:110px;'/></td>"
			    	  +" <td><input type='text' name='formbean.asgst1' class='asgst' value="+stogstam22+" style='height:25px;border:1px solid #ccc;background:#FFFF99;width:110px;'/></td>"
			    	  +"<td><input type='text' name='formbean.cgst1' class='cgst' value="+tax22+" style='height:25px;border:1px solid #ccc;background:#FFFF99;width:110px;' /></td>"
			    	  +" <td><input type='text' name='formbean.acgst1' class='acgst' value="+stogstam22+" style='height:25px;border:1px solid #ccc;background:#FFFF99;width:110px;' /></td>"
			    	  +"<td><input type='text' name='formbean.igst1' class='igst' value="+"NA"+" style='height:25px;border:1px solid #ccc;background:#FFFF99;width:110px;'/></td>"
			    	  +"<td><input type='text' name='formbean.aigst1' class='aigst' value="+"NA"+" style='height:25px;border:1px solid #ccc;background:#FFFF99;width:110px;'/></td>" 
			    	  +"<td><input type='text' name='formbean.gamount1' class='gamount' value="+stogstam2+" style='height:25px;border:1px solid #ccc;background:#FFFF99;width:110px;' /></td></tr>";
						...
						else if(x1.trim()=="InterState")
					   {
						...
						buffer=buffer+"<tr> <td><input type='text' name='formbean.onamount1' class='onamount' value="+stotalam2+" style='height:25px;border:1px solid #ccc;background:#FFFF99;width:110px;'/></td>"
	    		 		    +"<td><input type='text' name='formbean.sgst1' class='sgst' value="+"NA"+" style='height:25px;border:1px solid #ccc;background:#FFFF99;width:110px;'/></td>"
		    	  			...
		    	  			+"<td><input type='text' name='formbean.cgst1' class='cgst' value="+"NA"+" style='height:25px;border:1px solid #ccc;background:#FFFF99;width:110px;' /></td>"
		    	  			+" <td><input type='text' name='formbean.acgst1' class='acgst' value="+"NA"+" style='height:25px;border:1px solid #ccc;background:#FFFF99;width:110px;' /></td>"
		    	  			+"<td><input type='text' name='formbean.igst1' class='igst' value="+tax2+" style='height:25px;border:1px solid #ccc;background:#FFFF99;width:110px;'/></td>"
		    	  			+"<td><input type='text' name='formbean.aigst1' class='aigst' value="+stogstam2+" style='height:25px;border:1px solid #ccc;background:#FFFF99;width:110px;'/></td>" 
		    	  			+"<td><input type='text' name='formbean.gamount1' class='gamount' value="+stogstam2+" style='height:25px;border:1px solid #ccc;background:#FFFF99;width:110px;' /></td></tr>";
				  ...
				  if(tax3=="12")
				   ...
				   if(x1.trim()=="IntraState")
				   {
				    ...
				    tax33=Number(tax3) / 2;
				 	  buffer=buffer+"<tr> <td><input type='text' name='formbean.onamount1' class='onamount' value="+stotalam3+" style='height:25px;border:1px solid #ccc;background:#FFFF99;width:110px;'/></td>"
		    		  +"<td><input type='text' name='formbean.sgst1' class='sgst' value="+tax33+" style='height:25px;border:1px solid #ccc;background:#FFFF99;width:110px;'/></td>"
			    	  +" <td><input type='text' name='formbean.asgst1' class='asgst' value="+stogstam33+" style='height:25px;border:1px solid #ccc;background:#FFFF99;width:110px;'/></td>"
			    	  +"<td><input type='text' name='formbean.cgst1' class='cgst' value="+tax33+" style='height:25px;border:1px solid #ccc;background:#FFFF99;width:110px;' /></td>"
			    	  +" <td><input type='text' name='formbean.acgst1' class='acgst' value="+stogstam33+" style='height:25px;border:1px solid #ccc;background:#FFFF99;width:110px;' /></td>"
			    	  +"<td><input type='text' name='formbean.igst1' class='igst' value="+"NA"+" style='height:25px;border:1px solid #ccc;background:#FFFF99;width:110px;'/></td>"
			    	  +"<td><input type='text' name='formbean.aigst1' class='aigst' value="+"NA"+" style='height:25px;border:1px solid #ccc;background:#FFFF99;width:110px;'/></td>" 
			    	  +"<td><input type='text' name='formbean.gamount1' class='gamount' value="+stogstam3+" style='height:25px;border:1px solid #ccc;background:#FFFF99;width:110px;' /></td></tr>";
						...
						else if(x1.trim()=="InterState")
					   {
						...
						buffer=buffer+"<tr> <td><input type='text' name='formbean.onamount1' class='onamount' value="+stotalam3+" style='height:25px;border:1px solid #ccc;background:#FFFF99;width:110px;'/></td>"
	    		 		    +"<td><input type='text' name='formbean.sgst1' class='sgst' value="+"NA"+" style='height:25px;border:1px solid #ccc;background:#FFFF99;width:110px;'/></td>"
		    	  			...
		    	  			+"<td><input type='text' name='formbean.cgst1' class='cgst' value="+"NA"+" style='height:25px;border:1px solid #ccc;background:#FFFF99;width:110px;' /></td>"
		    	  			+" <td><input type='text' name='formbean.acgst1' class='acgst' value="+"NA"+" style='height:25px;border:1px solid #ccc;background:#FFFF99;width:110px;' /></td>"
		    	  			+"<td><input type='text' name='formbean.igst1' class='igst' value="+tax3+" style='height:25px;border:1px solid #ccc;background:#FFFF99;width:110px;'/></td>"
		    	  			+"<td><input type='text' name='formbean.aigst1' class='aigst' value="+stogstam3+" style='height:25px;border:1px solid #ccc;background:#FFFF99;width:110px;'/></td>" 
		    	  			+"<td><input type='text' name='formbean.gamount1' class='gamount' value="+stogstam3+" style='height:25px;border:1px solid #ccc;background:#FFFF99;width:110px;' /></td></tr>";
				 ...
				 //  alert("outloop length: "+count4);
				   if(x1.trim()=="IntraState")
				   {
				    ...
				    tax44=Number(tax4) / 2;
				 	  buffer=buffer+"<tr> <td><input type='text' name='formbean.onamount1' class='onamount' value="+stotalam4+" style='height:25px;border:1px solid #ccc;background:#FFFF99;width:110px;'/></td>"
		    		  +"<td><input type='text' name='formbean.sgst1' class='sgst' value="+tax44+" style='height:25px;border:1px solid #ccc;background:#FFFF99;width:110px;'/></td>"
			    	  +" <td><input type='text' name='formbean.asgst1' class='asgst' value="+stogstam44+" style='height:25px;border:1px solid #ccc;background:#FFFF99;width:110px;'/></td>"
			    	  +"<td><input type='text' name='formbean.cgst1' class='cgst' value="+tax44+" style='height:25px;border:1px solid #ccc;background:#FFFF99;width:110px;' /></td>"
			    	  +" <td><input type='text' name='formbean.acgst1' class='acgst' value="+stogstam44+" style='height:25px;border:1px solid #ccc;background:#FFFF99;width:110px;' /></td>"
			    	  +"<td><input type='text' name='formbean.igst1' class='igst' value="+"NA"+" style='height:25px;border:1px solid #ccc;background:#FFFF99;width:110px;'/></td>"
			    	  +"<td><input type='text' name='formbean.aigst1' class='aigst' value="+"NA"+" style='height:25px;border:1px solid #ccc;background:#FFFF99;width:110px;'/></td>" 
			    	  +"<td><input type='text' name='formbean.gamount1' class='gamount' value="+stogstam4+" style='height:25px;border:1px solid #ccc;background:#FFFF99;width:110px;' /></td></tr>";
						...
						else if(x1.trim()=="InterState")
					   {
						...
						buffer=buffer+"<tr> <td><input type='text' name='formbean.onamount1' class='onamount' value="+stotalam4+" style='height:25px;border:1px solid #ccc;background:#FFFF99;width:110px;'/></td>"
	    		 		    +"<td><input type='text' name='formbean.sgst1' class='sgst' value="+"NA"+" style='height:25px;border:1px solid #ccc;background:#FFFF99;width:110px;'/></td>"
		    	  			...
		    	  			+"<td><input type='text' name='formbean.cgst1' class='cgst' value="+"NA"+" style='height:25px;border:1px solid #ccc;background:#FFFF99;width:110px;' /></td>"
		    	  			+" <td><input type='text' name='formbean.acgst1' class='acgst' value="+"NA"+" style='height:25px;border:1px solid #ccc;background:#FFFF99;width:110px;' /></td>"
		    	  			+"<td><input type='text' name='formbean.igst1' class='igst' value="+tax4+" style='height:25px;border:1px solid #ccc;background:#FFFF99;width:110px;'/></td>"
		    	  			+"<td><input type='text' name='formbean.aigst1' class='aigst' value="+stogstam4+" style='height:25px;border:1px solid #ccc;background:#FFFF99;width:110px;'/></td>" 
		    	  			+"<td><input type='text' name='formbean.gamount1' class='gamount' value="+stogstam4+" style='height:25px;border:1px solid #ccc;background:#FFFF99;width:110px;' /></td></tr>";
				  ...
				  if(tax5=="0")
				   ...
				   if(x1.trim()=="IntraState")
				   {
				    ...
				    tax55=Number(tax5) / 2;
				 	  buffer=buffer+"<tr> <td><input type='text' name='formbean.onamount1' class='onamount' value="+stotalam5+" style='height:25px;border:1px solid #ccc;background:#FFFF99;width:110px;'/></td>"
		    		  +"<td><input type='text' name='formbean.sgst1' class='sgst' value="+tax5+" style='height:25px;border:1px solid #ccc;background:#FFFF99;width:110px;'/></td>"
			    	  +" <td><input type='text' name='formbean.asgst1' class='asgst' value="+"0"+" style='height:25px;border:1px solid #ccc;background:#FFFF99;width:110px;'/></td>"
			    	  +"<td><input type='text' name='formbean.cgst1' class='cgst' value="+tax5+" style='height:25px;border:1px solid #ccc;background:#FFFF99;width:110px;' /></td>"
			    	  +" <td><input type='text' name='formbean.acgst1' class='acgst' value="+"0"+" style='height:25px;border:1px solid #ccc;background:#FFFF99;width:110px;' /></td>"
			    	  +"<td><input type='text' name='formbean.igst1' class='igst' value="+"NA"+" style='height:25px;border:1px solid #ccc;background:#FFFF99;width:110px;'/></td>"
			    	  +"<td><input type='text' name='formbean.aigst1' class='aigst' value="+"NA"+" style='height:25px;border:1px solid #ccc;background:#FFFF99;width:110px;'/></td>" 
			    	  +"<td><input type='text' name='formbean.gamount1' class='gamount' value="+"0"+" style='height:25px;border:1px solid #ccc;background:#FFFF99;width:110px;' /></td></tr>";
				   ...
				   else if(x1.trim()=="InterState")
				   {
						buffer=buffer+"<tr> <td><input type='text' name='formbean.onamount1' class='onamount' value="+stotalam5+" style='height:25px;border:1px solid #ccc;background:#FFFF99;width:110px;'/></td>"
	    		 		    +"<td><input type='text' name='formbean.sgst1' class='sgst' value="+"NA"+" style='height:25px;border:1px solid #ccc;background:#FFFF99;width:110px;'/></td>"
		    	  			...
		    	  			+"<td><input type='text' name='formbean.cgst1' class='cgst' value="+"NA"+" style='height:25px;border:1px solid #ccc;background:#FFFF99;width:110px;' /></td>"
		    	  			+" <td><input type='text' name='formbean.acgst1' class='acgst' value="+"NA"+" style='height:25px;border:1px solid #ccc;background:#FFFF99;width:110px;' /></td>"
		    	  			+"<td><input type='text' name='formbean.igst1' class='igst' value="+tax5+" style='height:25px;border:1px solid #ccc;background:#FFFF99;width:110px;'/></td>"
		    	  			+"<td><input type='text' name='formbean.aigst1' class='aigst' value="+"0"+" style='height:25px;border:1px solid #ccc;background:#FFFF99;width:110px;'/></td>" 
		    	  			+"<td><input type='text' name='formbean.gamount1' class='gamount' value="+"0"+" style='height:25px;border:1px solid #ccc;background:#FFFF99;width:110px;' /></td></tr>";
			...
			alert(buffer);
			 ...
			 document.getElementById("table33").innerHTML=buffer;
			 if(x1.trim()=="IntraState")
				 {
	...
	if(val==nul)
		{
				...
				//alert(kk);
				document.getElementById("memo").value=kk;
...
function popup2()
{
	...
	function print1(){
		...
		if(a == true)
			{
			popitup('printdetails.jsp?value='+ a);
			}
		else
			{
				return false;
...
<s:actionmessage/>
  ...
  <table cellpadding="5" width="50%" style="padding:5px">  
  		...
  		<s:textfield name="formbean.type1" id="type1" cssClass="type1"  size="30" cssStyle="height:25px;border:1px solid #ccc;background:#FFFF99;display:none"></s:textfield>
       	...
       	<tr>
        	...
        	<td width="12.5%" style="padding-left:15px; padding-right:15px;">
        	 <sj:autocompleter name="formbean.nameofarea1" id="nameofarea1" cssClass="nameofarea1" list="usList2"  listValue="nameofarea1" size="30" cssStyle="height:25px;border:1px solid #ccc;background:#FFFF99" forceValidOption="false" onfocusout="areacode();getcity1();vouchercreate();"  ></sj:autocompleter>
        ...
        <td width="12.5%" style="padding-left:15px; padding-right:15px;"><label>Date</label></td>
        	<td width="12.5%" style="padding-left:15px; padding-right:15px;" valign="top"><sj:datepicker name="formbean.date" id="date" size="20" buttonImageOnly="true" displayFormat="yy-mm-dd" showButton="false"  changeYear="true" changeMonth="true" cssStyle="height:20px;border:1px solid #ccc;background:#FFFF99" onclick="view();" onchange="createcode();"/></td></tr>
        
        
         	<tr>
        	<td width="12.5%" style="padding-left:15px; padding-right:15px;"><label>Salesman&nbsp;Name</label></td>
        	<td width="12.5%" style="padding-left:15px; padding-right:15px;">
        	<sj:autocompleter name="formbean.salesmanname1" id="salesmanname1" cssClass="salesmanname1" list="usList3"  listValue="salesmanname1" size="30" cssStyle="height:25px;border:1px solid #ccc;background:#FFFF99" forceValidOption="false" onkeyup="createcode();" onfocusout="salecode();" ></sj:autocompleter>
   ...
   <fieldset style="width:30%; border:solid thin #c6d5e1;Padding:5px;">
	...
	<%--  <td width="9%" style="font-size:14px"> <s:select name="formbean.nameofitems[%{#status.count-1}]"   id="nameofitems" list="#{'':''}"  cssClass="nameofitems"  cssStyle=" border:1px solid #ccc;height:20px;background:#FFFF99;height:20px;width:200px;" onchange="PersonViewModel(this);PersonViewModel1(this);showdiv1();"></s:select><input type="hidden" name="formbean.nameofitems1" id="nameofitems1" class="nameofitems1"></input></td>
     --%>
        ...
        <td width="9%" style="font-size:14px"><s:textfield name="formbean.discs[%{#status.count-1}]" id="discs" cssClass="discs" size="10" cssStyle="height:20px;border:1px solid #ccc;background:#FFFF99" onkeyup="PersonViewModel(this);discou();pdiscou();gstp();" onfocusout="PersonViewModel(this);tototal();distotal();"></s:textfield><input type="hidden" name="formbean.discs4" id="discs4" class="discs4"></input></td>
   	   ...
   	   <td width="9%" style="font-size:14px"><s:textfield name="formbean.dis[%{#status.count-1}]" id="dis" cssClass="dis"  size="10" cssStyle="height:20px;border:1px solid #ccc;background:#FFFF99" onkeyup="pdiscou();" onfocusout="PersonViewModel(this);tototal();distotal();gstp();avi(this.value)"></s:textfield><input type="hidden" name="formbean.dis4" id="dis4" class="dis4"></input></td>
        	 
        
        <td width="9%" style="font-size:14px">
        <s:textfield name="formbean.amount4[%{#status.count-1}]" id="amount4" cssClass="amount4" size="10" cssStyle="height:20px;border:1px solid #ccc;background:#FFFF99"></s:textfield><input type="hidden" name="formbean.amount5" id="amount5" class="amount5"></input>
	...
	<table id="table33" border="0" width="52%" style="margin-left:50px;">
...
<td width="12.5%" style="padding-left:150px;" ><label>Add</label></td>
   ...
   <div align="right" style="width:99%;position:relative;  padding:7px;">
    <s:submit name="formbean.save" value="Save" cssClass="butStnd" onclick="print1();change2();" ></s:submit>
  </div>
    ...
    <a href="<s:url action="csalesmemeodelete" namespace="/" ><s:param  name="id" value="%{#attr.table111.id}"></s:param></s:url>" style="color:  #fff;text-decoration:none;font-size:12px;" class="print" onclick="return confirmation();">Delete</a>
     ...
     <a href="printdetails.jsp?value=<s:property value="%{#attr.table111.id}"/>&nameofarea=<s:property value="%{#attr.table111.nameofarea}"/>" style="color: #fff;text-decoration:none;font-size:12px;"><span style="color:green;" onclick="return popitup('printdetails.jsp?value=<s:property value="%{#attr.table111.id}"/>')">Print</span></a>	
	 </display:column>
	</s:if>
	<s:else>
