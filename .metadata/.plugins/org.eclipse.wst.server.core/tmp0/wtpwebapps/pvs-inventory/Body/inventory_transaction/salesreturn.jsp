...
<s:actionmessage/>
  ...
  <legend style="color:red;">ENTRY OF CASH/CREDIT MEMO FOR SALES RETURN</legend>
  
  <s:form action="salesreturncreation" namespace="/" method="post" autocomplete="off">
   ...
   <fieldset style="width:30%; border:solid thin #c6d5e1;Padding:5px;">
	...
	<!--  <tr  style="background-color:#4292b2;color:white;" align="center">        
	 ...
	 <tr style="background-color:#4292b2;color:white;" align="center">        
        ...
        <th width="9%" style="font-size:11.2px">  TR</th>     
    ...
    <tr>
       ...
       <%--  <s:textfield name="formbean.nameofitems" id="nameofitems"  cssClass="nameofitems" size="50" cssStyle="height:20px;border:1px solid #ccc;background:#FFFF99;" ></s:textfield>
		...
		<td width="9%" style="font-size:14px">
        <s:select name="formbean.tr" id="tr" list="#{'A':'A', 'D':'D'}" cssStyle=" border:1px solid #ccc;height:20px;background:#FFFF99;width:70px;" tabindex="3"></s:select></td>
        </td>	
        <td width="9%" style="font-size:14px">
	...
	<%--  <td width="9%" style="font-size:14px"> <s:select name="formbean.nameofitems[%{#status.count-1}]"   id="nameofitems" list="#{'':''}"  cssClass="nameofitems"  cssStyle=" border:1px solid #ccc;height:20px;background:#FFFF99;height:20px;width:200px;" onchange="PersonViewModel(this);PersonViewModel1(this);showdiv1();"></s:select><input type="hidden" name="formbean.nameofitems1" id="nameofitems1" class="nameofitems1"></input></td>
     --%>
		<td width="9%" style="font-size:14px">
        <s:textfield name="formbean.tr[%{#status.count-1}]" id="tr" cssClass="tr" size="10" cssStyle="height:20px;border:1px solid #ccc;background:#FFFF99" onkeyup="PersonViewModel(this);casetotal();pdiscou();gstp();" onfocusout="PersonViewModel(this);tototal();distotal();"></s:textfield><input type="hidden" name="formbean.tr" id="tr" class="tr"></input>
...
<td width="12.5%" style="padding-left:150px;" ><label>Add</label></td>
   ...
   <div align="right" style="width:99%;position:relative;  padding:7px;">
    ...
    <a href="<s:url action="salesreturnupdate" namespace="/" ><s:param  name="id" value="%{#attr.table111.id}"></s:param></s:url>" style="color:  #fff;text-decoration:none;font-size:12px;" class="classname">Update</a>
    </display:column>
    
    <display:column title="Delete" media="html" style="text-align: center;width:8%;background-color:#ecf2f6;" >
    <a href="<s:url action="salesreturndelete" namespace="/" ><s:param  name="id" value="%{#attr.table111.id}"></s:param></s:url>" style="color:  #fff;text-decoration:none;font-size:12px;" class="print" onclick="return confirmation();">Delete</a>
    </display:column>
	</s:if>
	<s:else>
