...
<s:actionmessage/>
    ...
    <s:textfield name="formbean.asondate" style="color:red;border:none;width:300px;text-align:center" readonly="true"></s:textfield></font>
	...
	<display:column  title="Dates"  style="background-color:#fff;"  sortable="false" headerClass="sortable" >
     <a href="<s:url action="reportedit" namespace="/" ><s:param  name="date" value="%{#attr.table.date}"></s:param><s:param  name="ledger" value="%{#attr.table.ledger}"></s:param></s:url>" style="color:  red;text-decoration:none;"><s:property value="%{#attr.table.date}"/></a>
   	</display:column>
   
    <display:column property="type"   title="Type"  style="background-color:#fff;"  sortable="false" headerClass="sortable" />
	
	<display:column property="voucher"   title="Voucher No"  style="background-color:#fff;"  sortable="false" headerClass="sortable" />
	
	<display:column property="refno"   title="Reference No"  style="background-color:#fff;"  sortable="false" headerClass="sortable" />
	
	<display:column property="refdate"   title="Reference Date"  style="background-color:#fff;"  sortable="false" headerClass="sortable" />
