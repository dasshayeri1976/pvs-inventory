...
function show()
{
	...
	//s1=s1.replace('&','*');
	var url = "./Body/transaction/getsrno.jsp";
...
function codeAdd044() 
{
	...
	{			
		...
		document.getElementById("serial").innerHTML=x1;		
	}
}
</script>
<script>
...
<body onload="partlist();getnarration();ccode1();ccode();"><center>
</s:if>
<s:else>
...
<s:actionmessage/>
  ...
  <legend style="color:red;"><h3>Statement Of Account Edit</h3></legend>
  <div align="left">
  <s:label>Serial No:</s:label><s:label id="serial"></s:label>
  </div>
  
  
  <s:form action="statementeditsave" namespace="/" method="post">
  <input type="hidden" name="formbean.id" value="<s:property value="formbean.id"/>"/>
  
  <div align="right">
  <s:label id="day1"></s:label><br/>
  <s:textfield id="showdate" name="formbean.showdate" style="border:none;width:65px;background:#FFFF99"></s:textfield>
 ...
 <br>
  ...
  <table width="100%" border="0" id="table">
  	   ...
  	   <tr>
  	   		...
  	   		<td width="12.5%" style="padding-right:5px"><s:select name="formbean.partforcontra" id="partforcontra" list="usList1" listKey="part1" value="formbean.part1" listValue="part1" cssStyle=" border:1px solid #ccc;height:20px;background:#FFFF99;width:150px;" onchange="ccode();"></s:select></td>
  	   ...
  	   <tr>
  	   		<td width="12.5%" style="padding-right:5px"><input type="checkbox" name="chk"></input></td>
  	   		<td width="12.5%" style="padding-right:5px"><s:select name="formbean.partforcontra" id="partforcontra" list="usList1" listKey="part" value="formbean.quantity[#status.index]" listValue="part" cssClass="part" cssStyle=" border:1px solid #ccc;height:20px;background:#FFFF99;width:150px;" onchange="ccode();"></s:select> <input type="hidden" name="formbean.contra1" class="contra1" id="contra1"></input></td>
  	   		<td style="padding-right:5px"><div style="width:110px"><s:textfield name="partcrbal" id="partcrbal" style="color:red;background:transparant;border:0;" readonly="true"></s:textfield></div></td>
  ...
  <table align="right">
  	...
  	<tr>
  		...
  		<td><s:textfield name="formbean.contradate" placeholder="yyyy-mm-dd" Style="height:20px;border:1px solid #ccc;background:#FFFF99"></s:textfield></td>
  	</tr>
 ...
 <label><u>Narration Details:</u></label><br>
